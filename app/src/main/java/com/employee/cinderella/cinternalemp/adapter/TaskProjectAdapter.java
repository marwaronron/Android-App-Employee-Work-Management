...
public class TaskProjectAdapter extends ArrayAdapter<Task> {
    Context context;
    int resource;
   // String nameEmployee;
    public TaskProjectAdapter(@NonNull Context context, int resource, @NonNull List<Task> objects) {
    ...
    public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
       ...
       // TextView txt_title = (TextView) v.findViewById(R.id.textViewTaskTitle);
        ...
        TextView txt_employee = (TextView) v.findViewById(R.id.textViewTaskEmployee);
        ...
        txt_employee.setText(getItem(position).getEmployee_id()); //to update
        ...
        if(emp_id.equals(getItem(position).getEmployee_id()) ){
            chbx.setVisibility(v.VISIBLE);
            txt_employee.setText("MY TASK");
          //  txt_employee.setTextColor(ContextCompat.getColor(context, R.color.colorAccent));
            txt_employee.setTypeface(txt_Deadline.getTypeface(), Typeface.BOLD);
           // layout.setBackgroundColor(ContextCompat.getColor(context, R.color.colorAccent));
        }else{
            final String   URL =  "http://"+ WSadressIP.WSIP+":5000/cinternal/getEmployeeById";
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                               ...
                               // nameEmployee =  product.getString("full_name");
                                txt_employee.setText("Assigned To: " +product.getString("full_name"));
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("id",getItem(position).getEmployee_id());
                    return params;
                }
            };;
